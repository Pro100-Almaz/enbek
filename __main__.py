...
for config_dict_per_filial in config.filials:
    if debug:
        # enbek_account = "Blonskaya_E@railways.kz"
        # enbek_password = "Elena1967*"
        # ecp_account = r"C:\Users\Administrator\Desktop\RPA_Robot\RPA_Robot\Robot\EnbekRobot\Files\ХОЗУ\ECP.p12"
        # ecp_password = "Elena1967*"
        # SAP_login = "HRROBOT"
        # SAP_password = "SapKtzh*2020"
        # SAP_post_code = "1100"
        # filial_name = "ХОЗУ"
        # enbek_account = "Blonskaya_E@railways.kz"
        # enbek_password = "Elena1967*"
        # ecp_account = r"C:\Users\Administrator\Desktop\RPA_Robot\RPA_Robot\Robot\EnbekRobot\Files\ЦРП\ECP.p12"
        # ecp_password = "Elena123*"
        # SAP_login = "HRROBOT"
        # SAP_password = "SapKtzh*2021"
        # SAP_post_code = "3500"
        # filial_name = "ЦРП"
        # enbek_account = "Zhailaubaeva_G@Railways.kz"
        # enbek_password = "Bagil@2102*"
        # ecp_account = r"C:\Users\Administrator\Desktop\RPA_Robot\RPA_Robot\Robot\EnbekRobot\Files\ЦФО\ECP.p12"
        # ecp_password = "Aa123456"
        # SAP_login = "HRROBOT"
        # SAP_password = "SapKtzh*2021"
        # SAP_post_code = "1600"
        # filial_name = "ЦФО"
        enbek_account = "Omirbek_S@railways.kz"
        enbek_password = "Salta*777"
